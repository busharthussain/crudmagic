...
class ViewCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'magic:views {name}';
     ...
     * @var string
     */
    protected $description = 'Generates magic views';
    ...
    {
        return [
            'index.blade.php' => __DIR__ . '/../../resources/stubs/' . config('magic.css_framework') . '/index.stub',
            'create.blade.php' => __DIR__ . '/../../resources/stubs/' . config('magic.css_framework') . '/create.stub',
            'edit.blade.php' => __DIR__ . '/../../resources/stubs/' . config('magic.css_framework') . '/edit.stub'
        ];
    }
